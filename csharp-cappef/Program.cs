...
namespace csharp_cappef // Note: actual namespace depends on the project name.
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                // Create
                Student nuovoStudente = new Student { Name = "Francesco", Surname = "Totti", Email = "francescototti" };
    ...
    public class SchoolContext : DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer("Data Source=localhost;Initial Catalog=ccappef;Integrated Security=True;Pooling=False");
        }
    }
}